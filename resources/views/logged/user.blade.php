...
@section('content')
    <div class="box">
        <div class="box-body">
            <form method="post" action='{{ url("users/update") }}' class="my_form row"
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <label for="f_inicio">Nombre de usuario</label> <input type="text" name="name"
                                        value="{{ $usuario->name }}" class="form-control input-lg" required>
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="email">Email del usuario</label><input type="email" name="email"
                                        value="{{ $usuario->email}}" class="form-control input-lg" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="email">Contraseña</label><input type="password" name="password"
                                        value="{{ $usuario->password}}" class="form-control input-lg" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id='submit' type="submit" name="mysubmit" value="Guardar"
                                        formMethod="post" formaction='{{ url("users/update/$usuario->id") }}'
